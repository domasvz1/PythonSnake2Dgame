...
# [0.2] will be releasing quickly this version for admiring
# -- after all that done, optimizations can be left for 0.3 and later versions
# -- also more ducumentation could be added and so on as always..
#-- [0.3] [postponed] update later,  make a "game over" window
# Learn and chnage created gameobject and learn the right naming to the variables/methods
# Drawing and checking might be considerede in the later patches (if needed)


# [0.2] version --Movement fixed, but had to removed whichpart list for the moment
...
class Snake:
    ...
    def drawthepart( self, pictureangle, surface, thecutpart ):
        self.surface.blit( pictureangle, surface, thecutpart )
    ...
    def draw( self, surface ):
        ...
        for cell in self.body[1:-1]:
            if cell[3] == False:
                ...
                if (cell[2] == pygame.K_UP and cell[4] == pygame.K_DOWN) or\
                    ...
                    self.drawthepart( self.pic90, cell[:2], ( 0, 80, 40, 40 ) )

                    
                elif (cell[2] == pygame.K_RIGHT and cell[4] == pygame.K_LEFT) or\
                    (cell[2] == pygame.K_LEFT and cell[4] == pygame.K_RIGHT):
                    self.drawthepart( self.pic, cell[:2], ( 40, 0, 40, 40 ) )

                    
                elif (cell[2] == pygame.K_UP and cell[4] == pygame.K_RIGHT) or\
                    (cell[2] == pygame.K_RIGHT and cell[4] == pygame.K_UP):
                    self.drawthepart( self.pic, cell[:2], ( 80, 0, 40, 40 ) )

                    
                elif (cell[2] == pygame.K_LEFT and cell[4] == pygame.K_UP) or\
                    (cell[2] == pygame.K_UP and cell[4] == pygame.K_LEFT):
                    self.drawthepart( self.pic90, cell[:2], ( 0, 40, 40, 40 ) )

                    
                elif (cell[2] == pygame.K_DOWN and cell[4] == pygame.K_LEFT) or\
                    (cell[2] == pygame.K_LEFT and cell[4] == pygame.K_DOWN):
                    self.drawthepart( self.pic180, cell[:2], ( 40, 40, 40, 40 ) )

                    
                elif (cell[2] == pygame.K_RIGHT and cell[4] == pygame.K_DOWN) or\
                    (cell[2] == pygame.K_DOWN and cell[4] == pygame.K_RIGHT):
                    self.drawthepart( self.pic270, cell[:2], ( 40, 80, 40, 40 ) )


            elif cell[3] == True:
                if (cell[2] == pygame.K_UP and cell[4] == pygame.K_DOWN) or\
                    (cell[2] == pygame.K_DOWN and cell[4] == pygame.K_UP):
                    self.drawthepart( self.pic90, cell[:2], ( 40, 80, 40, 40 ) )
                    
                elif (cell[2] == pygame.K_RIGHT and cell[4] == pygame.K_LEFT) or\
                    (cell[2] == pygame.K_LEFT and cell[4] == pygame.K_RIGHT):
                    self.drawthepart( self.pic, cell[:2], ( 40, 40, 40, 40 ) )
                    
                elif (cell[2] == pygame.K_UP and cell[4] == pygame.K_RIGHT) or\
                    (cell[2] == pygame.K_RIGHT and cell[4] == pygame.K_UP):
                    self.drawthepart( self.pic, cell[:2], ( 80, 40, 40, 40 ) )
                    
                elif (cell[2] == pygame.K_LEFT and cell[4] == pygame.K_UP) or\
                    (cell[2] == pygame.K_UP and cell[4] == pygame.K_LEFT):
                    self.drawthepart( self.pic90, cell[:2], ( 40, 40, 40, 40 ) )
                    
                elif (cell[2] == pygame.K_DOWN and cell[4] == pygame.K_LEFT) or\
                    (cell[2] == pygame.K_LEFT and cell[4] == pygame.K_DOWN):
                    self.drawthepart( self.pic180, cell[:2], ( 40, 0, 40, 40 ) )
                    
                elif (cell[2] == pygame.K_RIGHT and cell[4] == pygame.K_DOWN) or\
                    (cell[2] == pygame.K_DOWN and cell[4] == pygame.K_RIGHT):
                    self.drawthepart( self.pic270, cell[:2], ( 0, 80, 40, 40 ) )
        ###
        ...
        if self.body[-1][4] == pygame.K_UP and self.body[-1][3] == False:
            self.drawthepart( self.pic90, self.body[-1][:2], ( 0, 0, 40, 40 ) )
     
        elif self.body[-1][4] == pygame.K_UP and self.body[-1][3] == True:
            self.drawthepart( self.pic90, self.body[-1][:2], ( 40, 0, 40, 40 ) )
            
        elif self.body[-1][4] == pygame.K_DOWN and self.body[-1][3] == False:
            self.drawthepart( self.pic270, self.body[-1][:2], ( 40, 120, 40, 40 ) )
            
        elif self.body[-1][4] == pygame.K_DOWN and self.body[-1][3] == True:
            self.drawthepart( self.pic270, self.body[-1][:2], ( 0, 120, 40, 40 ) )
            
        elif self.body[-1][4] == pygame.K_RIGHT and self.body[-1][3] == False:
            self.drawthepart( self.pic, self.body[-1][:2], ( 120, 0, 40, 40 ) )
            
        elif self.body[-1][4] == pygame.K_RIGHT and self.body[-1][3] == True:
            self.drawthepart( self.pic, self.body[-1][:2], ( 120, 40, 40, 40 ) )
            
        elif self.body[-1][4] == pygame.K_LEFT and self.body[-1][3] == False:
            self.drawthepart( self.pic180, self.body[-1][:2], ( 0, 40, 40, 40 ) )
            
        elif self.body[-1][4] == pygame.K_LEFT and self.body[-1][3] == True:
            self.drawthepart( self.pic180, self.body[-1][:2], ( 0, 0, 40, 40 ) )
